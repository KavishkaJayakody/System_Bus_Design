...
the design closes timing at 115.43\,MHz against a 50\,MHz requirement, fully
constrained.
...
Logic elements          & 1{,}667\\
Registers               & 1{,}297\\
$F_{\max}$              & \textbf{115.43\,MHz}\\
\bottomrule
\end{tabular}
\end{table}
...
Logic elements        & 1{,}667 / 114{,}480\\
Registers             & 1{,}297\\
Memory bits (all M9K) & 81{,}920\\
Worst setup slack     & 11.337\,ns\\
Worst hold slack      & 0.366\,ns\\
$F_{\max}$ (slow, 1200\,mV, 85\,$^\circ$C) & \textbf{115.43\,MHz}\\
\bottomrule
\end{tabular}
\end{table}
